...
public class daycare_frag3_parent extends Fragment implements View.OnClickListener {
        ...
        if(flag==0) {
          ...
          //  pd.show();
            ...
            if(filePath==null && photo.getDrawable()==null)
            {
                ...
                fragment33 fragobj = new fragment33(name, contact, email);
...
class fragment33
{
    ...
    public fragment33(String name,String contact, String email)
    {
        this.name=name;

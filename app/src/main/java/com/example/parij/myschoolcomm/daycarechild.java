...
public class daycarechild extends AppCompatActivity {
    ...
    TextView admissiondate, class1, division, gender, dateOfBirth, bloodGroup, classTeacher, contactNo;
    ...
    protected void onStart() {
        super.onStart();
        SessionManagement.retrieveSharedPreferences(daycarechild.this);

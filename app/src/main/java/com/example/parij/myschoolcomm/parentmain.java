...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menuMemories) {
            Intent intent = new Intent(parentmain.this, MemoriesUser.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position)
            {
                ...
                case 0: fragment1_parentmain obj= new fragment1_parentmain();
                return obj;

                case 1: fragment2_parentmain obj1= new fragment2_parentmain();
                return obj1;

                case 2: fragment3_parentmain obj2=new fragment3_parentmain();
                return obj2;

...
public class daycare_frag2_parent extends Fragment implements View.OnClickListener {
                ...
                else
                {
                    ...
                    uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            reference.child(username+"Mother").setValue(downloadurl);
                            pd.dismiss();
    ...
    public void onClick(View v) {
        ...
        if(flag==0) {
            ...
            if(filePath==null && photo.getDrawable()==null)
            {
                ...
                //uploading the image
                fragment22 fragobj = new fragment22(name, contact, email);

                reference.child("mother").child(username).setValue(fragobj);
    ...
    public void onStart() {
      ...
      //  View rootView = inflater.inflate(R.layout.fragment1_parentmain, container, false);
       ...
       // SessionManagement.retrieveSharedPreferences(context);
        ...
        database=FirebaseDatabase.getInstance();
        DatabaseReference databaseReference= database.getReference("ParentProfile").child("mother");
        ...
        final String user=username+"Mother";
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
...
class fragment22
{
    ...
    public fragment22(String name,String contact, String email)
    {
        this.name=name;

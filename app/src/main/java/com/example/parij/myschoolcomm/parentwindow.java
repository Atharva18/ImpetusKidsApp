...
public class parentwindow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parentwindow);
                    ...
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            for (DataSnapshot data : dataSnapshot.getChildren()) {
                                ...
                                if (mroll.equalsIgnoreCase(data.getKey())) {
                                    ...
                                    if (dname.equalsIgnoreCase(mname)) {
                                        flag = 1;
                                        break;
                                    }
                            ...
                            if (flag == 1) {
                                ...
                                Intent intent = new Intent(parentwindow.this,adminparent.class);

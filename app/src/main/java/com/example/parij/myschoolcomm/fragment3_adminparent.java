...
public class fragment3_adminparent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.activity_fragment3_adminparent, container, false);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (student.getUsername().equals(username)) {
                        ...
                        name1.setText(student.getGuardian().getName());
                        contact1.setText(student.getGuardian().getPhone());
                        email1.setText(student.getGuardian().getEmail());
